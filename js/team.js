        ...
        pending.map(req => h('div', { key: req.id, className: 'bg-surface border border-edge rounded-xl p-4' },
          h('div', { className: 'flex items-start gap-3 mb-3' },
            ...
            h('div', { className: 'flex-1' },
              ...
              req.message && h('div', { className: 'mt-2 text-sm text-ctext2 bg-sunken border border-edge rounded-lg px-3 py-2' }, req.message),h('div', { className: 'mt-2 text-xs text-ctext3' }, formatDateTime(req.created_at)),
            ),
          ),
