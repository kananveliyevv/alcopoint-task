        ...
        h('div', { className: 'p-4 border-b border-edge flex items-center justify-between' },
          h('div', { className: 'flex items-center gap-2.5' },
            ...
            h('div', { className: 'flex flex-col leading-none' },
              h('span', { className: 'font-bold tracking-tight text-base' }, 'Alcopoint-Task'),
              h('span', { className: 'text-[9px] text-ctext3 tracking-wider font-normal' }, 'Created by Kanan Valiyev'),
            ),
          ),
          h(PrefsToggle),
        ),
